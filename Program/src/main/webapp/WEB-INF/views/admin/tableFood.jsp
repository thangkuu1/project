                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Danh sách món ăn
                                   	<a href="/Project/admin/loadFood"><button class="btn btn-primary" style="float: right; margin-top: -7px;">Thêm món ăn</button></a>
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                            	<c:forEach items="${LIST_DTO_FOOD_BY_ID }" var="item">
                                            		<tr class="odd gradeX">
                                            			...
                                            			<td style="text-align: center"><img alt="" src="${pageContext.request.contextPath}/image/${item.image_food}" width="80px" height="80px"></td>
                                            			<td style="text-align: center">
                                            				<a href="/Project/admin/food/${item.id_food }" class="btn btn-primary" style="font-size: 20px"><i class="fa fa-edit" style="font-size: 24px;"></i></a>
                                            			</td>
                                            			<td style="text-align: center">
                                            				<a href="/Project/admin/deletefood/${item.id_food }"><button class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true" style="font-size: 24px"></i></button></a>
                                            			</td>
                                            		</tr>
                                            	</c:forEach>                          
                                            </tbody>

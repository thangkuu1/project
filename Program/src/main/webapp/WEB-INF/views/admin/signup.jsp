...
<link rel="stylesheet" href="/Project/resources/css/signup.css">
</head>
<body>
	<div class="login-form">
		<form:form action="/Project/admin/saveUser" method="post" enctype="multipart/form-data">
			<h2 class="text-center">Đăng ký tài khoản nhà hàng</h2>       
